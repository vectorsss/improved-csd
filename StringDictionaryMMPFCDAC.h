...
#ifndef _STRINGDICTIONARY_MMPFC_DAC_H
#define _STRINGDICTIONARY_MMPFC_DAC_H
...
class StringDictionaryMMPFCDAC : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFCDAC();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFCDAC(IteratorDictString *it);
