...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC_VLS_LLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC_VLS_LLCP_H
...
class StringDictionaryMMRPFCDACVLSLlcp : public StringDictionary
{     
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCDACVLSLlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCDACVLSLlcp(IteratorDictString *it);
