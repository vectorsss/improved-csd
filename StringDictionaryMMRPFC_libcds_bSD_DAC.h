...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC_H
...
class StringDictionaryMMRPFCbSDDAC : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDDAC();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDDAC(IteratorDictString *it);
	...
	protected:
		...
		*/
		...
		inline uint decodeCompareString(uchar *ptr, uchar *compared, uint *pos, int len);
		inline uint decodeString(uchar *str, uchar *ptr, uint limitstring, uint limitbytes);
