...
StringDictionaryMMRPFCbSDDACLlcp::StringDictionaryMMRPFCbSDDACLlcp()
{
	this->type = MMRPFCbSDDACLLCP;
	this->elements = 0;
	this->maxlength = 0;
}

StringDictionaryMMRPFCbSDDACLlcp::StringDictionaryMMRPFCbSDDACLlcp(IteratorDictString *it)
{
...
inline uint
StringDictionaryMMRPFCbSDDACLlcp::decodeString(uchar *str, uchar *ptr, uint limitstring, uint limitbytes)
{
...
uint 
StringDictionaryMMRPFCbSDDACLlcp::locate(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDACLlcp::extract(size_t id, uint *strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDACLlcp::locatePrefix(uchar *str, uint strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDACLlcp::locateSubstr(uchar *str, uint strLen)
{
...
uint 
StringDictionaryMMRPFCbSDDACLlcp::locateRank(uint rank)
{
	return rank;
}

IteratorDictString*
StringDictionaryMMRPFCbSDDACLlcp::extractPrefix(uchar *str, uint strLen)
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDACLlcp::extractTable()
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDACLlcp::extractSubstr(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDACLlcp::extractRank(uint rank, uint *strLen)
{
	return extract(rank, strLen);
}

size_t 
StringDictionaryMMRPFCbSDDACLlcp::getSize()
{
	return (bytesStrings*sizeof(uchar))+this->selPointers->getSize()+llcp->getSize()+sizeof(StringDictionaryMMRPFCbSDDACLlcp)+rp->getSize();
}

void 
StringDictionaryMMRPFCbSDDACLlcp::save(ofstream &out)
{
...
StringDictionary*
StringDictionaryMMRPFCbSDDACLlcp::load(ifstream &in)
{
	size_t type = loadValue<uint32_t>(in);
	if(type != MMRPFCbSDDACLLCP) return NULL;

	cout << "Reading MMRPFCbSDDACLLCP" <<endl;

	StringDictionaryMMRPFCbSDDACLlcp *dict = new StringDictionaryMMRPFCbSDDACLlcp();

	dict->type = MMRPFCbSDDACLLCP;
...
//void
//StringDictionaryMMRPFCbSDDACLlcp::decodeNextString(uchar **ptr, uint lenPrefix, uchar *str, uint *strLen)
//{
//	uint lenSuffix;
//
...
//uint
//StringDictionaryMMRPFCbSDDACLlcp::searchPrefix(uchar **ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
...
//
//uint
//StringDictionaryMMRPFCbSDDACLlcp::searchDistinctPrefix(uchar *ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
//	uint id = 1;
//	uint lenPrefix;
//
...
void StringDictionaryMMRPFCbSDDACLlcp::printInfo() {
...
//    printf("XBWInt -> %lu\n", this->xbw->getSize());
//    printf("----------------------------\n");
    printf("MMPFC structure: %lu\n", sizeof(StringDictionaryMMRPFCbSDDACLlcp));
    printf("TOTAL  -> %lu\n", this->getSize());
//    printf("****************************\n");
//    printf("\n\n");
//
...
void StringDictionaryMMRPFCbSDDACLlcp::buildLcps(uchar *dict, uint *pointers, vector<size_t>*llcp, vector<size_t>*rlcp, uint l, uint r) {
    uint m = (l + r) / 2;
//    uint level = bits(r-l);
//    if (level > 10)
...
/*
inline uint
StringDictionaryMMRPFCbSDDACLlcp::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos) 
{
...
inline uint
StringDictionaryMMRPFCbSDDACLlcp::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos, int len) 
{
...
inline int 
StringDictionaryMMRPFCbSDDACLlcp::doSearchString(uchar * string, uint len, uint lpos, uint rpos, uint l, uint r) {
