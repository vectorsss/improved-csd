...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_H
...
class StringDictionaryMMRPFCbSD : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSD();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSD(IteratorDictString *it);
