...
namespace cds_utils
{
	...
	// Implemented by Susana Ladra, added to libcds by Fernando Silva
	inline uint bitreadL (uint *e, ulong p, uint len)
	...
	inline void bitwriteL (register uint *e, register ulong p,
