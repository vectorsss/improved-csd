...
namespace cds_static
{
	...
	class BitSequenceBuilderRPSC : public BitSequenceBuilder
	{
		public:
			...
			BitSequenceBuilderRPSC(Repair *rp, BitSequenceBuilder * bsb,PermutationBuilder *, uint samplingC, uint delta, uint ss_rate);
			BitSequenceBuilderRPSC(BitSequenceBuilder * bsb,PermutationBuilder *, uint samplingC, uint delta, uint ss_rate);
			BitSequenceBuilderRPSC(BitSequenceBuilder * bsb,uint samplingC, uint delta, uint ss_rate);
