...
namespace cds_static
{
	...
	class BitSequenceRPSN : public BitSequence
	{
		...
		public:
			BitSequenceRPSN(uint * symbols, size_t n, BitSequenceBuilder *bsb, PermutationBuilder *pb, uint samplingC, uint delta, uint ss_rate, bool deleteSymbols=false);
			BitSequenceRPSN(uint * symbols, size_t n, Repair *rp, BitSequenceBuilder *bsb, PermutationBuilder *pb, uint samplingC, uint delta, uint ss_rate, bool deleteSymbols=false);
