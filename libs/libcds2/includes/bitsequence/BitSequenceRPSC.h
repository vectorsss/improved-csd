...
namespace cds_static
{
	...
	class BitSequenceRPSC : public BitSequence
	{
		...
		public:
			...
			*/
			BitSequenceRPSC(uint * symbols, size_t n, BitSequenceBuilder *bsb, PermutationBuilder *pb, uint samplingC, uint delta, uint ss_rate, bool deleteSymbols=false);
			BitSequenceRPSC(uint * symbols, size_t n, Repair *rp, BitSequenceBuilder *bsb, PermutationBuilder *pb, uint samplingC, uint delta, uint ss_rate, bool deleteSymbols=false);
