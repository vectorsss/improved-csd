...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC_LLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC_LLCP_H
...
class StringDictionaryMMRPFCbSDDACLlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDDACLlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDDACLlcp(IteratorDictString *it);
