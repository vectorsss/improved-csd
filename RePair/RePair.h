...
class RePair
{
	...
	*/
		...
		uint expandRuleLimit(uint rule, uchar *str, uint limit);
	...
	protected:
		...
		*/
		...
		int expandRuleAndCompareStringLimit(uint rule, uchar *str, uint *pos, int limit);
		...
		*/
		...
		/** Version of the previous one returning the first different character.
		 */
		int extractStringAndCompareDAC2(uint id, uchar* str, uint *pos);
		...
		*/
		...
		friend class StringDictionaryMMRPFCbSD;
		friend class StringDictionaryMMRPFCbSDLlcp;
		friend class StringDictionaryMMRPFCbSDRlcp;

		friend class StringDictionaryMMRPFCbSDDiff;

		friend class StringDictionaryMMRPFCbSDDAC;
		friend class StringDictionaryMMRPFCbSDDACLlcp;
		friend class StringDictionaryMMRPFCbSDDACRlcp;

		friend class StringDictionaryMMRPFCbSDDAC2;
		friend class StringDictionaryMMRPFCbSDDAC2Llcp;
		friend class StringDictionaryMMRPFCbSDDAC2Rlcp;

		friend class StringDictionaryMMRPFCDACVLS;
		friend class StringDictionaryMMRPFCDACVLSLlcp;
		friend class StringDictionaryMMRPFCDACVLSRlcp;

		friend class StringDictionaryMMRPFCDAC2VLS;
		friend class StringDictionaryMMRPFCDAC2VLSLlcp;
		friend class StringDictionaryMMRPFCDAC2VLSRlcp;
