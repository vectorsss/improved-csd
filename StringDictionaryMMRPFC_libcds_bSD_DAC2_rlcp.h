...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC2_RLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC2_RLCP_H
...
class StringDictionaryMMRPFCbSDDAC2Rlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDDAC2Rlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDDAC2Rlcp(IteratorDictString *it);
