...
#ifndef _STRINGDICTIONARY_MMPFC_H
#define _STRINGDICTIONARY_MMPFC_H
...
class StringDictionaryMMPFC : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFC();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFC(IteratorDictString *it);
