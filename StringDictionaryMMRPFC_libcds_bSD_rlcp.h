...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_RLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_RLCP_H
...
class StringDictionaryMMRPFCbSDRlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDRlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDRlcp(IteratorDictString *it);
