...
#ifndef _STRINGDICTIONARY_MMPFC_LIBCDS_bSD_RLCP_H
#define _STRINGDICTIONARY_MMPFC_LIBCDS_bSD_RLCP_H
...
class StringDictionaryMMPFCbSDRlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFCbSDRlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFCbSDRlcp(IteratorDictString *it);
	...
	protected:
		...
		*/
		...
		int compareNewPattern(uchar *pattern, uchar *compared, uint *p, int len);
