...
StringDictionaryMMRPFCDAC2VLSLlcp::StringDictionaryMMRPFCDAC2VLSLlcp()
{
	this->type = MMRPFCDAC2VLSLLCP;
	this->elements = 0;
	this->maxlength = 0;
}

StringDictionaryMMRPFCDAC2VLSLlcp::StringDictionaryMMRPFCDAC2VLSLlcp(IteratorDictString *it)
{
...
inline uint
StringDictionaryMMRPFCDAC2VLSLlcp::decodeString(uchar *str, uint pos, uint limit)
{
...
uint 
StringDictionaryMMRPFCDAC2VLSLlcp::locate(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCDAC2VLSLlcp::extract(size_t id, uint *strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCDAC2VLSLlcp::locatePrefix(uchar *str, uint strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCDAC2VLSLlcp::locateSubstr(uchar *str, uint strLen)
{
...
uint 
StringDictionaryMMRPFCDAC2VLSLlcp::locateRank(uint rank)
{
	return rank;
}

IteratorDictString*
StringDictionaryMMRPFCDAC2VLSLlcp::extractPrefix(uchar *str, uint strLen)
{
...
IteratorDictString*
StringDictionaryMMRPFCDAC2VLSLlcp::extractTable()
{
...
IteratorDictString*
StringDictionaryMMRPFCDAC2VLSLlcp::extractSubstr(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCDAC2VLSLlcp::extractRank(uint rank, uint *strLen)
{
	return extract(rank, strLen);
}

size_t 
StringDictionaryMMRPFCDAC2VLSLlcp::getSize()
{
	return llcp->getSize()+sizeof(StringDictionaryMMRPFCDAC2VLSLlcp)+rp->getSize();
}

void 
StringDictionaryMMRPFCDAC2VLSLlcp::save(ofstream &out)
{
	...
	rp->save(out, MMRPFCDAC2VLSLLCP);
}



StringDictionary*
StringDictionaryMMRPFCDAC2VLSLlcp::load(ifstream &in)
{
	size_t type = loadValue<uint32_t>(in);
	if(type != MMRPFCDAC2VLSLLCP) return NULL;

	cout << "Reading MMRPFCDAC2VLSLLCP" <<endl;

	StringDictionaryMMRPFCDAC2VLSLlcp *dict = new StringDictionaryMMRPFCDAC2VLSLlcp();

	dict->type = MMRPFCDAC2VLSLLCP;
...
//void
//StringDictionaryMMRPFCDAC2VLSLlcp::decodeNextString(uchar **ptr, uint lenPrefix, uchar *str, uint *strLen)
//{
//	uint lenSuffix;
//
...
//uint
//StringDictionaryMMRPFCDAC2VLSLlcp::searchPrefix(uchar **ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
...
//
//uint
//StringDictionaryMMRPFCDAC2VLSLlcp::searchDistinctPrefix(uchar *ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
//	uint id = 1;
//	uint lenPrefix;
//
...
void StringDictionaryMMRPFCDAC2VLSLlcp::printInfo() {
...
//    printf("XBWInt -> %lu\n", this->xbw->getSize());
//    printf("----------------------------\n");
    printf("MMPFC structure: %lu\n", sizeof(StringDictionaryMMRPFCDAC2VLSLlcp));
    printf("TOTAL  -> %lu\n", this->getSize());
//    printf("****************************\n");
//    printf("\n\n");
//
...
void StringDictionaryMMRPFCDAC2VLSLlcp::buildLcps(uchar *dict, uint *pointers, vector<size_t>*llcp, vector<size_t>*rlcp, uint l, uint r) {
    uint m = (l + r) / 2;
//    uint level = bits(r-l);
//    if (level > 10)
...
/*
inline uint
StringDictionaryMMRPFCDAC2VLSLlcp::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos)
{
...
inline uint
StringDictionaryMMRPFCDAC2VLSLlcp::decodeCompareString(uint dictmPos, uchar *pattern, uint *pos)
{
...
inline int 
StringDictionaryMMRPFCDAC2VLSLlcp::doSearchString(uchar * string, uint len, uint lpos, uint rpos, uint l, uint r) {
...
inline int StringDictionaryMMRPFCDAC2VLSLlcp::compareNewPattern(uchar *pattern, uchar *compared, uint *pos) {
	uint p=*pos;
