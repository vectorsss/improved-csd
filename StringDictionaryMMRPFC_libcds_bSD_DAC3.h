/* StringDictionaryMMRPFCbSDDAC3.h
 * 
 *
 * TODO
 *
 ...
 */
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC3_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC3_H
...
class StringDictionaryMMRPFCbSDDAC3 : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDDAC3();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDDAC3(IteratorDictString *it);
