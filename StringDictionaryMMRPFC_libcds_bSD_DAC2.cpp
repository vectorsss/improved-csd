...
StringDictionaryMMRPFCbSDDAC2::StringDictionaryMMRPFCbSDDAC2()
{
	this->type = MMRPFCbSDDAC2;
	this->elements = 0;
	this->maxlength = 0;
}

StringDictionaryMMRPFCbSDDAC2::StringDictionaryMMRPFCbSDDAC2(IteratorDictString *it)
{
...
inline uint
StringDictionaryMMRPFCbSDDAC2::decodeString(uchar *str, uint pos, uint limit)
{
...
uint 
StringDictionaryMMRPFCbSDDAC2::locate(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDAC2::extract(size_t id, uint *strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDAC2::locatePrefix(uchar *str, uint strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDAC2::locateSubstr(uchar *str, uint strLen)
{
...
uint 
StringDictionaryMMRPFCbSDDAC2::locateRank(uint rank)
{
	return rank;
}

IteratorDictString*
StringDictionaryMMRPFCbSDDAC2::extractPrefix(uchar *str, uint strLen)
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDAC2::extractTable()
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDAC2::extractSubstr(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDAC2::extractRank(uint rank, uint *strLen)
{
	return extract(rank, strLen);
}

size_t 
StringDictionaryMMRPFCbSDDAC2::getSize()
{
	return this->textStrings->getSize()+this->selPointers->getSize()+llcp->getSize()+rlcp->getSize()+sizeof(StringDictionaryMMRPFCbSDDAC2)+rp->getSize();
}

void 
StringDictionaryMMRPFCbSDDAC2::save(ofstream &out)
{
...
StringDictionary*
StringDictionaryMMRPFCbSDDAC2::load(ifstream &in)
{
	size_t type = loadValue<uint32_t>(in);
	if(type != MMRPFCbSDDAC2) return NULL;

	cout << "Reading MMRPFCbSDDAC2" <<endl;

	StringDictionaryMMRPFCbSDDAC2 *dict = new StringDictionaryMMRPFCbSDDAC2();

	dict->type = MMRPFCbSDDAC2;
...
//void
//StringDictionaryMMRPFCbSDDAC2::decodeNextString(uchar **ptr, uint lenPrefix, uchar *str, uint *strLen)
//{
//	uint lenSuffix;
//
...
//uint
//StringDictionaryMMRPFCbSDDAC2::searchPrefix(uchar **ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
...
//
//uint
//StringDictionaryMMRPFCbSDDAC2::searchDistinctPrefix(uchar *ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
//	uint id = 1;
//	uint lenPrefix;
//
...
void StringDictionaryMMRPFCbSDDAC2::printInfo() {
...
//    printf("XBWInt -> %lu\n", this->xbw->getSize());
//    printf("----------------------------\n");
    printf("MMPFC structure: %lu\n", sizeof(StringDictionaryMMRPFCbSDDAC2));
    printf("TOTAL  -> %lu\n", this->getSize());
//    printf("****************************\n");
//    printf("\n\n");
//
...
void StringDictionaryMMRPFCbSDDAC2::buildLcps(uchar *dict, uint *pointers, vector<size_t>*llcp, vector<size_t>*rlcp, uint l, uint r) {
    uint m = (l + r) / 2;
//    uint level = bits(r-l);
//    if (level > 10)
...
/*
inline uint
StringDictionaryMMRPFCbSDDAC2::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos) 
{
...
inline uint
StringDictionaryMMRPFCbSDDAC2::decodeCompareString(uint dictmPos, uchar *pattern, uint *pos) 
{
...
inline int 
StringDictionaryMMRPFCbSDDAC2::doSearchString(uchar * string, uint len, uint lpos, uint rpos, uint l, uint r) {
...
inline int StringDictionaryMMRPFCbSDDAC2::compareNewPattern(uchar *pattern, uchar *compared, uint *pos) {
	uint p=*pos;
