...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC2_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC2_H
...
class StringDictionaryMMRPFCbSDDAC2 : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDDAC2();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDDAC2(IteratorDictString *it);
	...
	protected:
		...
		DAC *textStrings;	//! Front-Coding of all remaining strings
