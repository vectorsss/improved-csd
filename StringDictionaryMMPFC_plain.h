...
#ifndef _STRINGDICTIONARY_MMPFC_PLAIN_H
#define _STRINGDICTIONARY_MMPFC_PLAIN_H
...
class StringDictionaryMMPFCPLAIN : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFCPLAIN();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFCPLAIN(IteratorDictString *it);
