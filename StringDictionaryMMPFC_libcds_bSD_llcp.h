...
#ifndef _STRINGDICTIONARY_MMPFC_LIBCDS_bSD_LLCP_H
#define _STRINGDICTIONARY_MMPFC_LIBCDS_bSD_LLCP_H
...
class StringDictionaryMMPFCbSDLlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFCbSDLlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFCbSDLlcp(IteratorDictString *it);
