...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC2_VLS_RLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC2_VLS_RLCP_H
...
class StringDictionaryMMRPFCDAC2VLSRlcp : public StringDictionary
{     
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCDAC2VLSRlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCDAC2VLSRlcp(IteratorDictString *it);
