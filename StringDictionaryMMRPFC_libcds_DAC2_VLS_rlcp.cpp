...
StringDictionaryMMRPFCDAC2VLSRlcp::StringDictionaryMMRPFCDAC2VLSRlcp()
{
	this->type = MMRPFCDAC2VLSRLCP;
	this->elements = 0;
	this->maxlength = 0;
}

StringDictionaryMMRPFCDAC2VLSRlcp::StringDictionaryMMRPFCDAC2VLSRlcp(IteratorDictString *it)
{
...
inline uint
StringDictionaryMMRPFCDAC2VLSRlcp::decodeString(uchar *str, uint pos, uint limit)
{
...
uint 
StringDictionaryMMRPFCDAC2VLSRlcp::locate(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCDAC2VLSRlcp::extract(size_t id, uint *strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCDAC2VLSRlcp::locatePrefix(uchar *str, uint strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCDAC2VLSRlcp::locateSubstr(uchar *str, uint strLen)
{
...
uint 
StringDictionaryMMRPFCDAC2VLSRlcp::locateRank(uint rank)
{
	return rank;
}

IteratorDictString*
StringDictionaryMMRPFCDAC2VLSRlcp::extractPrefix(uchar *str, uint strLen)
{
...
IteratorDictString*
StringDictionaryMMRPFCDAC2VLSRlcp::extractTable()
{
...
IteratorDictString*
StringDictionaryMMRPFCDAC2VLSRlcp::extractSubstr(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCDAC2VLSRlcp::extractRank(uint rank, uint *strLen)
{
	return extract(rank, strLen);
}

size_t 
StringDictionaryMMRPFCDAC2VLSRlcp::getSize()
{
	return llcp->getSize()+sizeof(StringDictionaryMMRPFCDAC2VLSRlcp)+rp->getSize();
}

void 
StringDictionaryMMRPFCDAC2VLSRlcp::save(ofstream &out)
{
	...
	rp->save(out, MMRPFCDAC2VLSRLCP);
}



StringDictionary*
StringDictionaryMMRPFCDAC2VLSRlcp::load(ifstream &in)
{
	size_t type = loadValue<uint32_t>(in);
	if(type != MMRPFCDAC2VLSRLCP) return NULL;

	cout << "Reading MMRPFCDAC2VLSRLCP" <<endl;

	StringDictionaryMMRPFCDAC2VLSRlcp *dict = new StringDictionaryMMRPFCDAC2VLSRlcp();

	dict->type = MMRPFCDAC2VLSRLCP;
...
//void
//StringDictionaryMMRPFCDAC2VLSRlcp::decodeNextString(uchar **ptr, uint lenPrefix, uchar *str, uint *strLen)
//{
//	uint lenSuffix;
//
...
//uint
//StringDictionaryMMRPFCDAC2VLSRlcp::searchPrefix(uchar **ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
...
//
//uint
//StringDictionaryMMRPFCDAC2VLSRlcp::searchDistinctPrefix(uchar *ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
//	uint id = 1;
//	uint lenPrefix;
//
...
void StringDictionaryMMRPFCDAC2VLSRlcp::printInfo() {
...
//    printf("XBWInt -> %lu\n", this->xbw->getSize());
//    printf("----------------------------\n");
    printf("MMPFC structure: %lu\n", sizeof(StringDictionaryMMRPFCDAC2VLSRlcp));
    printf("TOTAL  -> %lu\n", this->getSize());
//    printf("****************************\n");
//    printf("\n\n");
//
...
void StringDictionaryMMRPFCDAC2VLSRlcp::buildLcps(uchar *dict, uint *pointers, vector<size_t>*llcp, vector<size_t>*rlcp, uint l, uint r) {
    uint m = (l + r) / 2;
//    uint level = bits(r-l);
//    if (level > 10)
...
/*
inline uint
StringDictionaryMMRPFCDAC2VLSRlcp::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos)
{
...
inline uint
StringDictionaryMMRPFCDAC2VLSRlcp::decodeCompareString(uint dictmPos, uchar *pattern, uint *pos)
{
...
inline int 
StringDictionaryMMRPFCDAC2VLSRlcp::doSearchString(uchar * string, uint len, uint lpos, uint rpos, uint l, uint r) {
...
inline int StringDictionaryMMRPFCDAC2VLSRlcp::compareNewPattern(uchar *pattern, uchar *compared, uint *pos) {
	uint p=*pos;
