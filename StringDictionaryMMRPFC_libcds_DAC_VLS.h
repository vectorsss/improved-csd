...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC_VLS_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC_VLS_H
...
class StringDictionaryMMRPFCDACVLS : public StringDictionary
{     
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCDACVLS();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCDACVLS(IteratorDictString *it);
