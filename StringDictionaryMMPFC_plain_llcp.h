...
#ifndef _STRINGDICTIONARY_MMPFC_PLAIN_LLCP_H
#define _STRINGDICTIONARY_MMPFC_PLAIN_LLCP_H
...
class StringDictionaryMMPFCPLAINLlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFCPLAINLlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFCPLAINLlcp(IteratorDictString *it);
