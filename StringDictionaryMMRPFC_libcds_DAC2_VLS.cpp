...
StringDictionaryMMRPFCDAC2VLS::StringDictionaryMMRPFCDAC2VLS()
{
	this->type = MMRPFCDAC2VLS;
	this->elements = 0;
	this->maxlength = 0;
}

StringDictionaryMMRPFCDAC2VLS::StringDictionaryMMRPFCDAC2VLS(IteratorDictString *it)
{
...
inline uint
StringDictionaryMMRPFCDAC2VLS::decodeString(uchar *str, uint pos, uint limit)
{
...
uint 
StringDictionaryMMRPFCDAC2VLS::locate(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCDAC2VLS::extract(size_t id, uint *strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCDAC2VLS::locatePrefix(uchar *str, uint strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCDAC2VLS::locateSubstr(uchar *str, uint strLen)
{
...
uint 
StringDictionaryMMRPFCDAC2VLS::locateRank(uint rank)
{
	return rank;
}

IteratorDictString*
StringDictionaryMMRPFCDAC2VLS::extractPrefix(uchar *str, uint strLen)
{
...
IteratorDictString*
StringDictionaryMMRPFCDAC2VLS::extractTable()
{
...
IteratorDictString*
StringDictionaryMMRPFCDAC2VLS::extractSubstr(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCDAC2VLS::extractRank(uint rank, uint *strLen)
{
	return extract(rank, strLen);
}

size_t 
StringDictionaryMMRPFCDAC2VLS::getSize()
{
	return llcp->getSize()+rlcp->getSize()+sizeof(StringDictionaryMMRPFCDAC2VLS)+rp->getSize();
}

void 
StringDictionaryMMRPFCDAC2VLS::save(ofstream &out)
{
	...
	rp->save(out, MMRPFCDAC2VLS);
}



StringDictionary*
StringDictionaryMMRPFCDAC2VLS::load(ifstream &in)
{
	size_t type = loadValue<uint32_t>(in);
	if(type != MMRPFCDAC2VLS) return NULL;

	cout << "Reading MMRPFCDAC2VLS" <<endl;

	StringDictionaryMMRPFCDAC2VLS *dict = new StringDictionaryMMRPFCDAC2VLS();

	dict->type = MMRPFCDAC2VLS;
...
//void
//StringDictionaryMMRPFCDAC2VLS::decodeNextString(uchar **ptr, uint lenPrefix, uchar *str, uint *strLen)
//{
//	uint lenSuffix;
//
...
//uint
//StringDictionaryMMRPFCDAC2VLS::searchPrefix(uchar **ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
...
//
//uint
//StringDictionaryMMRPFCDAC2VLS::searchDistinctPrefix(uchar *ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
//	uint id = 1;
//	uint lenPrefix;
//
...
void StringDictionaryMMRPFCDAC2VLS::printInfo() {
...
//    printf("XBWInt -> %lu\n", this->xbw->getSize());
//    printf("----------------------------\n");
    printf("MMPFC structure: %lu\n", sizeof(StringDictionaryMMRPFCDAC2VLS));
    printf("TOTAL  -> %lu\n", this->getSize());
//    printf("****************************\n");
//    printf("\n\n");
//
...
void StringDictionaryMMRPFCDAC2VLS::buildLcps(uchar *dict, uint *pointers, vector<size_t>*llcp, vector<size_t>*rlcp, uint l, uint r) {
    uint m = (l + r) / 2;
//    uint level = bits(r-l);
//    if (level > 10)
...
/*
inline uint
StringDictionaryMMRPFCDAC2VLS::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos)
{
...
inline uint
StringDictionaryMMRPFCDAC2VLS::decodeCompareString(uint dictmPos, uchar *pattern, uint *pos)
{
...
inline int 
StringDictionaryMMRPFCDAC2VLS::doSearchString(uchar * string, uint len, uint lpos, uint rpos, uint l, uint r) {
...
inline int StringDictionaryMMRPFCDAC2VLS::compareNewPattern(uchar *pattern, uchar *compared, uint *pos) {
	uint p=*pos;
