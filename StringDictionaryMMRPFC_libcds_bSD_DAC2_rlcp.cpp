...
StringDictionaryMMRPFCbSDDAC2Rlcp::StringDictionaryMMRPFCbSDDAC2Rlcp()
{
	this->type = MMRPFCbSDDAC2RLCP;
	this->elements = 0;
	this->maxlength = 0;
}

StringDictionaryMMRPFCbSDDAC2Rlcp::StringDictionaryMMRPFCbSDDAC2Rlcp(IteratorDictString *it)
{
...
inline uint
StringDictionaryMMRPFCbSDDAC2Rlcp::decodeString(uchar *str, uint pos, uint limit)
{
...
uint 
StringDictionaryMMRPFCbSDDAC2Rlcp::locate(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDAC2Rlcp::extract(size_t id, uint *strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDAC2Rlcp::locatePrefix(uchar *str, uint strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDAC2Rlcp::locateSubstr(uchar *str, uint strLen)
{
...
uint 
StringDictionaryMMRPFCbSDDAC2Rlcp::locateRank(uint rank)
{
	return rank;
}

IteratorDictString*
StringDictionaryMMRPFCbSDDAC2Rlcp::extractPrefix(uchar *str, uint strLen)
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDAC2Rlcp::extractTable()
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDAC2Rlcp::extractSubstr(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDAC2Rlcp::extractRank(uint rank, uint *strLen)
{
	return extract(rank, strLen);
}

size_t 
StringDictionaryMMRPFCbSDDAC2Rlcp::getSize()
{
	return this->textStrings->getSize()+this->selPointers->getSize()+rlcp->getSize()+sizeof(StringDictionaryMMRPFCbSDDAC2Rlcp)+rp->getSize();
}

void 
StringDictionaryMMRPFCbSDDAC2Rlcp::save(ofstream &out)
{
...
StringDictionary*
StringDictionaryMMRPFCbSDDAC2Rlcp::load(ifstream &in)
{
	size_t type = loadValue<uint32_t>(in);
	if(type != MMRPFCbSDDAC2RLCP) return NULL;

	cout << "Reading MMRPFCbSDDAC2RLCP" <<endl;

	StringDictionaryMMRPFCbSDDAC2Rlcp *dict = new StringDictionaryMMRPFCbSDDAC2Rlcp();

	dict->type = MMRPFCbSDDAC2RLCP;
...
//void
//StringDictionaryMMRPFCbSDDAC2Rlcp::decodeNextString(uchar **ptr, uint lenPrefix, uchar *str, uint *strLen)
//{
//	uint lenSuffix;
//
...
//uint
//StringDictionaryMMRPFCbSDDAC2Rlcp::searchPrefix(uchar **ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
...
//
//uint
//StringDictionaryMMRPFCbSDDAC2Rlcp::searchDistinctPrefix(uchar *ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
//	uint id = 1;
//	uint lenPrefix;
//
...
void StringDictionaryMMRPFCbSDDAC2Rlcp::printInfo() {
...
//    printf("XBWInt -> %lu\n", this->xbw->getSize());
//    printf("----------------------------\n");
    printf("MMPFC structure: %lu\n", sizeof(StringDictionaryMMRPFCbSDDAC2Rlcp));
    printf("TOTAL  -> %lu\n", this->getSize());
//    printf("****************************\n");
//    printf("\n\n");
//
...
void StringDictionaryMMRPFCbSDDAC2Rlcp::buildLcps(uchar *dict, uint *pointers, vector<size_t>*llcp, vector<size_t>*rlcp, uint l, uint r) {
    uint m = (l + r) / 2;
//    uint level = bits(r-l);
//    if (level > 10)
...
/*
inline uint
StringDictionaryMMRPFCbSDDAC2Rlcp::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos)
{
...
inline uint
StringDictionaryMMRPFCbSDDAC2Rlcp::decodeCompareString(uint dictmPos, uchar *pattern, uint *pos)
{
...
inline int 
StringDictionaryMMRPFCbSDDAC2Rlcp::doSearchString(uchar * string, uint len, uint lpos, uint rpos, uint l, uint r) {
	...
	if (rlcpvalue > r) {
		...
		uint p = 0;
		int cmp = decodeCompareString(dictmPos, string+r, &p);
		p += r;
...
inline int StringDictionaryMMRPFCbSDDAC2Rlcp::compareNewPattern(uchar *pattern, uchar *compared, uint *pos) {
	uint p=*pos;
