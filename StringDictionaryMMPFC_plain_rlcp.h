...
#ifndef _STRINGDICTIONARY_MMPFC_PLAIN_RLCP_H
#define _STRINGDICTIONARY_MMPFC_PLAIN_RLCP_H
...
class StringDictionaryMMPFCPLAINRlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFCPLAINRlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFCPLAINRlcp(IteratorDictString *it);
