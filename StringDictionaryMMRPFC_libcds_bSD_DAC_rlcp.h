...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC_RLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC_RLCP_H
...
class StringDictionaryMMRPFCbSDDACRlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDDACRlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDDACRlcp(IteratorDictString *it);
