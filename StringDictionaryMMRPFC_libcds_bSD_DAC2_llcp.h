...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC2_LLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_DAC2_LLCP_H
...
class StringDictionaryMMRPFCbSDDAC2Llcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDDAC2Llcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDDAC2Llcp(IteratorDictString *it);
