...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_LLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_bSD_LLCP_H
...
class StringDictionaryMMRPFCbSDLlcp : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCbSDLlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCbSDLlcp(IteratorDictString *it);
