...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC2_VLS_LLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC2_VLS_LLCP_H
...
class StringDictionaryMMRPFCDAC2VLSLlcp : public StringDictionary
{     
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCDAC2VLSLlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCDAC2VLSLlcp(IteratorDictString *it);
