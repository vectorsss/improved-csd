...
#ifndef _STRINGDICTIONARY_MMPFC_LIBCDS_bSD_H
#define _STRINGDICTIONARY_MMPFC_LIBCDS_bSD_H
...
class StringDictionaryMMPFCbSD : public StringDictionary
{
	public:
		/** Generic Constructor. */
		StringDictionaryMMPFCbSD();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMPFCbSD(IteratorDictString *it);
