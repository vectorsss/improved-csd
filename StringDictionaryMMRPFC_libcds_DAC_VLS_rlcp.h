...
#ifndef _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC_VLS_RLCP_H
#define _STRINGDICTIONARY_MMRPFC_LIBCDS_DAC_VLS_RLCP_H
...
class StringDictionaryMMRPFCDACVLSRlcp : public StringDictionary
{     
	public:
		/** Generic Constructor. */
		StringDictionaryMMRPFCDACVLSRlcp();

		/** Class Constructor.
		    @param it: iterator scanning the original set of strings.
		*/
		StringDictionaryMMRPFCDACVLSRlcp(IteratorDictString *it);
