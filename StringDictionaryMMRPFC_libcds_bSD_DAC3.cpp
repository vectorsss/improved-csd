/* StringDictionaryMMRPFCbSDDAC3.cpp
 *
 *
 *  TODO
 *
...
#include "StringDictionaryMMRPFC_libcds_bSD_DAC3.h"

StringDictionaryMMRPFCbSDDAC3::StringDictionaryMMRPFCbSDDAC3()
{
	this->type = MMRPFCbSDDAC3;
	this->elements = 0;
	this->maxlength = 0;
}

StringDictionaryMMRPFCbSDDAC3::StringDictionaryMMRPFCbSDDAC3(IteratorDictString *it)
{
...
inline uint
StringDictionaryMMRPFCbSDDAC3::decodeString(uchar *str, uint pos, uint limit)
{
...
uint 
StringDictionaryMMRPFCbSDDAC3::locate(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDAC3::extract(size_t id, uint *strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDAC3::locatePrefix(uchar *str, uint strLen)
{
...
IteratorDictID*
StringDictionaryMMRPFCbSDDAC3::locateSubstr(uchar *str, uint strLen)
{
...
uint 
StringDictionaryMMRPFCbSDDAC3::locateRank(uint rank)
{
	return rank;
}

IteratorDictString*
StringDictionaryMMRPFCbSDDAC3::extractPrefix(uchar *str, uint strLen)
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDAC3::extractTable()
{
...
IteratorDictString*
StringDictionaryMMRPFCbSDDAC3::extractSubstr(uchar *str, uint strLen)
{
...
uchar *
StringDictionaryMMRPFCbSDDAC3::extractRank(uint rank, uint *strLen)
{
	return extract(rank, strLen);
}

size_t 
StringDictionaryMMRPFCbSDDAC3::getSize()
{
	return llcp->getSize()+sizeof(StringDictionaryMMRPFCbSDDAC3)+rp->getSize();
}

void 
StringDictionaryMMRPFCbSDDAC3::save(ofstream &out)
{
	...
	rp->save(out, MMRPFCbSDDAC3);
}



StringDictionary*
StringDictionaryMMRPFCbSDDAC3::load(ifstream &in)
{
	size_t type = loadValue<uint32_t>(in);
	if(type != MMRPFCbSDDAC3) return NULL;

	cout << "Reading MMRPFCbSDDAC3" <<endl;

	StringDictionaryMMRPFCbSDDAC3 *dict = new StringDictionaryMMRPFCbSDDAC3();

	dict->type = MMRPFCbSDDAC3;
...
//void
//StringDictionaryMMRPFCbSDDAC3::decodeNextString(uchar **ptr, uint lenPrefix, uchar *str, uint *strLen)
//{
//	uint lenSuffix;
//
...
//uint
//StringDictionaryMMRPFCbSDDAC3::searchPrefix(uchar **ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
...
//
//uint
//StringDictionaryMMRPFCbSDDAC3::searchDistinctPrefix(uchar *ptr, uint scanneable, uchar *decoded, uint *decLen, uchar *str, uint strLen)
//{
//	uint id = 1;
//	uint lenPrefix;
//
...
void StringDictionaryMMRPFCbSDDAC3::printInfo() {
...
//    printf("XBWInt -> %lu\n", this->xbw->getSize());
//    printf("----------------------------\n");
    printf("MMPFC structure: %lu\n", sizeof(StringDictionaryMMRPFCbSDDAC3));
    printf("TOTAL  -> %lu\n", this->getSize());
//    printf("****************************\n");
//    printf("\n\n");
//
...
void StringDictionaryMMRPFCbSDDAC3::buildLcps(uchar *dict, uint *pointers, vector<size_t>*llcp, vector<size_t>*rlcp, uint l, uint r) {
    uint m = (l + r) / 2;
//    uint level = bits(r-l);
//    if (level > 10)
...
/*
inline uint
StringDictionaryMMRPFCbSDDAC3::decodeCompareString(uchar *ptr, uchar *pattern, uint *pos)
{
...
inline uint
StringDictionaryMMRPFCbSDDAC3::decodeCompareString(uint dictmPos, uchar *pattern, uint *pos)
{
...
inline int 
StringDictionaryMMRPFCbSDDAC3::doSearchString(uchar * string, uint len, uint lpos, uint rpos, uint l, uint r) {
...
inline int StringDictionaryMMRPFCbSDDAC3::compareNewPattern(uchar *pattern, uchar *compared, uint *pos) {
	uint p=*pos;
